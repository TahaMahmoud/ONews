...
struct Helper {
    ...
    static func showSuccessNotification(message: String) {
        CRNotifications.showNotification(type: CRNotifications.success, title: "Success".localized, message: message, dismissDelay: 3)
    }
    
    static func showErrorNotification(message: String) {
        CRNotifications.showNotification(type: CRNotifications.error, title: "Error".localized, message: message, dismissDelay: 3)
    }
